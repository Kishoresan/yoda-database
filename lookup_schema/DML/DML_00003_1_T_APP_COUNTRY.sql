--
-- Dumping data for table LOOKUP.T_APP_COUNTRY
--

INSERT INTO LOOKUP.T_APP_COUNTRY (ISO_CODE, COUNTRY_NAME, COUNTRY_NICENAME, ISO3_CODE, NUMCODE, INT_DIALING_CODE) VALUES
